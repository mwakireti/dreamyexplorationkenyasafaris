                ...
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        ...
                        <ul>
                            ...
                            <li><span><i class="fas fa-circle"></i></span> Mount Kenya.</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tour_details_leftside_wrapper">
                        <div class="tour_details_heading_wrapper">
                            <div class="tour_details_top_heading">
                                ...
                                <h5><i class="fas fa-map-marker-alt"></i> Mount Kenya.
                                </h5>
                            </div>
                        ...
                        <div class="tour_details_img_wrapper">
                            <div class="slider slider-for">
                                <div>
                                    <img src="assets/img/common/MOUNTKENYA.png" alt="img">
                                </div>
                                <!-- <div>
                        ...
                        <div class="tour_details_boxed">
                            ...
                            <div class="tour_details_boxed_inner">
                                <p> Spanning 277 square miles, Mount Kenya National Park is a breathtaking wilderness that surrounds Mount Kenya, Africa’s second-highest peak after Kilimanjaro. This UNESCO World Heritage Site is a haven for diverse wildlife, stunning landscapes, and thrilling outdoor adventures.
                                    The park is home to iconic African wildlife, including elephants, buffaloes, black rhinos, and leopards, as well as rare species such as the sunni buck and the elusive albino zebra. In the lower-altitude forests, visitors can spot colobus monkeys swinging through the trees. With its glacial peaks, alpine meadows, and dense montane forests, Mount Kenya National Park offers some of the best hiking, trekking, and mountaineering experiences in Africa.
                                    Beyond its wildlife and landscapes, the park holds deep cultural significance for the Kikuyu, Meru, and Embu communities, who farm the fertile lower slopes of the mountain. Whether you’re an avid hiker, a wildlife enthusiast, or a nature lover, Mount Kenya National Park provides a unique blend of adventure, conservation, and cultural heritage.</p>
                                <!-- <p>
                        ...
                        <div class="tour_details_boxed">
                            <h3 class="heading_theme">Mount Kenya.</h3>
                            <div class="map_area">
                                <iframe
