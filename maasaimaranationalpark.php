                ...
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        ...
                        <ul>
                            ...
                            <li><span><i class="fas fa-circle"></i></span> Maasai Mara National Park.</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tour_details_leftside_wrapper">
                        <div class="tour_details_heading_wrapper">
                            <div class="tour_details_top_heading">
                                ...
                                <h5><i class="fas fa-map-marker-alt"></i> Maasai Mara National Park.
                                </h5>
                            </div>
                        ...
                        <div class="tour_details_boxed">
                            <h3 class="heading_theme">Maasai Mara National Park.</h3>
                            <div class="map_area">
                                <iframe
