                    ...
                    <div class="tour_details_leftside_wrapper">
                        <div class="tour_details_heading_wrapper">
                            <div class="tour_details_top_heading">
                                ...
                                <h5><i class="fas fa-map-marker-alt"></i> Lake Nakuru
                                </h5>
                            </div>
                        ...
                        <div class="tour_details_img_wrapper">
                            <div class="slider slider-for">
                                <div>
                                    <img src="assets/img/common/LAKEN.png" alt="img">
                                </div>
                                <!-- <div>
                        ...
                        <div class="tour_details_boxed">
                            ...
                            <div class="tour_details_boxed_inner">
                                <p> Situated in Kenya’s Great Rift Valley, Lake Nakuru National Park is a breathtaking safari destination, famous for its vast flocks of flamingos that transform the lake into a shimmering pink spectacle. Surrounded by rugged escarpments, cascading waterfalls, and acacia woodlands, the park offers a stunning landscape teeming with diverse wildlife and exceptional photography opportunities.
                                    Beyond the iconic flamingos, Lake Nakuru is a prime location to spot black and white rhinos, lions, leopards, hippos, buffaloes, and the endangered Rothschild giraffe. The southern end of the lake, near Flamingo Hill, is particularly rich in wildlife, with predators like lions and leopards often seen resting in the trees.
                                    Ideal for both luxury and budget safaris, Lake Nakuru National Park provides game drives with spectacular wildlife encounters, scenic viewpoints, and birdwatching experiences. Whether you're a nature lover, a wildlife enthusiast, or a photography traveler, this park promises an unforgettable Kenyan safari adventure.</p>
                                <!-- <p>
                        ...
                        <div class="tour_details_boxed">
                            <h3 class="heading_theme">Lake Nakuru.</h3>
                            <div class="map_area">
                                <iframe
