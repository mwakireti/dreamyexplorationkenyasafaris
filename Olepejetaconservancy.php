            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        <h2> Ole Pejeta Conservancy.</h2>
                        <ul>
                            <li><a href="index.html">Home</a></li>
                            <li><span><i class="fas fa-circle"></i></span><a href="tour-search.html">Safari</a></li>
                            <li><span><i class="fas fa-circle"></i></span> Ole Pejeta Conservancy.</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tour_details_leftside_wrapper">
                        <div class="tour_details_heading_wrapper">
                            <div class="tour_details_top_heading">
                                ...
                                <h5><i class="fas fa-map-marker-alt"></i> Ole Pejeta Conservancy
                                </h5>
                            </div>
                        ...
                        <div class="tour_details_img_wrapper">
                            <div class="slider slider-for">
                                <div>
                                    <img src="assets/img/common/OLEPARK.png" alt="img">
                                </div>
                                <!-- <div>
                        ...
                        <div class="tour_details_boxed">
                            ...
                            <div class="tour_details_boxed_inner">
                                <p> Located on the Laikipia Plateau, between the Aberdare Mountains and Mount Kenya, Ol Pejeta Conservancy is one of East Africa’s most renowned wildlife reserves. Spanning diverse landscapes of semi-arid grasslands, woodlands, riverine forests, and wetlands, this conservancy is a prime destination for Big Five safaris and world-class wildlife conservation efforts.
                                    Ol Pejeta is globally recognized for its dedicated rhino conservation programs, home to over 140 critically endangered black rhinos and the last two northern white rhinos on the planet, guarded by highly trained protection squads and expert veterinarians. This makes it one of the best places in Africa to witness rhino conservation firsthand.
                                    In addition to rhinos, Ol Pejeta hosts the Sweetwaters Chimpanzee Sanctuary, the only place in Kenya where visitors can see rescued and rehabilitated orphaned chimpanzees. The conservancy also provides incredible opportunities for game drives, guided bush walks, night safaris, and horseback riding alongside wildlife.
                                    Whether you’re looking for a luxury safari lodge, an eco-friendly tented camp, or an immersive conservation experience, Ol Pejeta Conservancy offers an unforgettable Kenyan safari adventure filled with wildlife encounters, breathtaking landscapes, and impactful conservation initiatives.</p>
                                <!-- <p>
                        ...
                        <div class="tour_details_boxed">
                            <h3 class="heading_theme">Ole Pejeta Conservancy.</h3>
                            <div class="map_area">
                                <iframe
